...
typedef struct tagFrame
{
	...
	unsigned char  Reversed[19];		//unused
...
IR_SDK_API int IRSDK_SaveFrame2Video(char *pFile, Frame *pFrame, unsigned char Op, unsigned char isSaveObj, STAT_OBJ *pObj);
IR_SDK_API int IRSDK_ReadVideo2Frame(char *pFile, Frame *pFrame, unsigned int Index, unsigned char Op, T_SAVE_HEAD *pVideoHead, STAT_OBJ *pObj);

IR_SDK_API int IRSDK_SaveFrame2AVI(char* pFile, unsigned char *pGray, unsigned short Width, unsigned short Height, unsigned char Op, int PalType, int Pal);
